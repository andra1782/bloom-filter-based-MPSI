...
std::vector<long> run_experiment(const std::vector<std::vector<long>>& client_sets, 
    ...
    std::cout << "Client prep time: " << client_computation_time << " ms";
    std::cout << ", Client online time: " << leader_client_computation_time << " ms";
    std::cout << ", Server computation time: " << server_authorize_time << " ms";
    std::cout << ", Server intersect time: " << server_intersect_time << " ms";
